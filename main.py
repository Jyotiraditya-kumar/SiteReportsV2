...
@app.get("/site_report/{report_id}/{id}/household")
async def households(report_id, id):
    resp = C.get_households(report_id=report_id, id=id)
    return resp
...
@app.get("/site_report/{report_id}/{id}/medical")
async def medical(report_id, id):
    resp = C.get_medical(report_id=report_id, id=id)
    return resp
